...
<body>
    ...
    <section class="trip">
        ...
        <div class="char">
            <img src="https://resize.indiatvnews.com/en/resize/newbucket/715_-/2021/08/jagannath-temple-pti-1627842679.jpg" alt="">
        </div>
        <div class="para1">
            <p>
            The Jagannath Temple is an important Hindu temple dedicated to Jagannath, a form of Vishnu - one of the trinity of supreme divinity in Hinduism, in Puri in the state of Odisha on the eastern coast of India. The present temple was rebuilt from the 10th century onwards, on the site of pre existing temples in the compund but not the main Jagannatha temple, and begun by Anantavarman Chodaganga, the first king of the Eastern Ganga dynasty.
            </p>
        </div>
